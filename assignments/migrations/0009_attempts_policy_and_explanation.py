...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('assignments', '0008_rename_assign_grd_asg_stu_idx_assignments_assignm_81964c_idx_and_more'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(choices=[('best', 'Best'), ('latest', 'Latest')], default='latest', max_length=10),
        ),
        migrations.AddField(
